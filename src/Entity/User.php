...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Comment::class, mappedBy="contentby", orphanRemoval=true)
     */
    private $createdAt;
    ...
    public function removeCreatedAt(Comment $createdAt): self
    {
        if ($this->createdAt->removeElement($createdAt)) {
            ...
            if ($createdAt->getContentby() === $this) {
                $createdAt->setContentby(null);
            }
        }
